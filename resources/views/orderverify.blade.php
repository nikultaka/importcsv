...
<head>
    ...
    <link href="{{ asset('assets/css/orderverify.css') }}" rel="stylesheet">
    ...
    <div class="login-page">
        <div class="form">
            <form id="csvForm" onsubmit="return false" autocomplete="off" method="POST" enctype="multipart/form-data"
                ...
                <button onclick="verifyAddress()" type="submit">verify Address</button>
            </form>
        </div>
    </div>
</body>
...
<script type="text/javascript" src="{{ asset('assets/js/orderverify.js') }}"></script>
</html>
